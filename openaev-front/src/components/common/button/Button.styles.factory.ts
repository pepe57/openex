...
import { createGradientSx, createTextGradientSx, getButtonContentSx, getDisabledSx } from './Button.utils';
...
export const createBaseStyles = (params: StyleFactoryParams): SxProps<Theme> => {
  ...
  return {
    ...
    '& .MuiButton-startIcon, & .MuiButton-endIcon': { '& > *:nth-of-type(1)': { fontSize: sizeConfig.iconSize } },
...
export const createPrimarySolidStyles = (params: StyleFactoryParams): SxProps<Theme> => {
  ...
  return {
    ...
    ...(selected && { backgroundColor: currentColor.hover }),

    '&:hover': { backgroundColor: currentColor.hover },
...
export const createSecondarySolidStyles = (params: StyleFactoryParams): SxProps<Theme> => {
  ...
  return {
    ...
    ...(selected && { backgroundColor: alpha(currentColor.main, 0.15) }),

    '&:hover': { backgroundColor: alpha(currentColor.main, 0.15) },
...
export const createTertiaryGradientStyles = (params: StyleFactoryParams): SxProps<Theme> => {
  ...
  return {
    ...
    ...(selected && { backgroundColor: alpha(gradientColors.start, 0.15) }),
    ...
    '&:hover': { backgroundColor: alpha(gradientColors.start, 0.15) },
    '&:active': { backgroundColor: alpha(gradientColors.start, 0.25) },
