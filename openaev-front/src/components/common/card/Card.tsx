import { Card as CardMui, CardActionArea, Stack, type StackProps, type SxProps, useTheme } from '@mui/material';
...
const Card = ({
  ...
  let paddingStyle: SxProps = { padding: theme.spacing(3) };
  if (padding === 'horizontal') {
    ...
    paddingStyle = { padding: theme.spacing(1) };
